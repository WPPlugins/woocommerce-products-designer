...
//            var_dump($data);
   ...
   private function get_user_orders_designs($user_id)
   {
        ...
        <div id="wpc-cart-box" class="">
            ...
            ?>
                ...
                <div class="total-price">
                    <span id="total_order"><?php echo wc_price($product_price); ?></span>
                </div>
            </div>
            <?php
            if (isset($wp_query->query_vars["edit"])) 
    ...
    private function register_scripts() {
        ...
        wp_enqueue_script('wpd-accounting', WPD_URL . 'public/js/accounting.min.js', array('jquery'), WPD_VERSION, false);
